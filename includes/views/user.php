<div class="row">
	<form method="<?php if($this->id): ?>put<?php else: ?>post<?php endif; ?>" action="api/user/" class="col-xs-12">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="nicknameNew" id="nicknameNew" value="<?php echo $this->nicknameNew; ?>">
        </div>

        <div class="form-group">
            <label for="password" >Passwort</label>
            <input type="text" class="form-control" name="password" id="password" value="<?php echo $this->password; ?>">
        </div>
...
<script type="text/javascript">
	...
	editModal.find('form').bind('submit', function(e, that) {
		...
		var requiredFields = ['#firstname', '#lastname', '#nicknameNew', '#password', '#beispielFeldEmail1];
